<?php
    ...
    if (empty($_POST['correo'])) {
        ...
        $datos = $C_clientes->findOne(['correo' => $destino]);
        ...
        if(!empty($datos)){
            ...
            try {
                ...
                $mail->Subject = 'Recuperación de contraseña - Cocinas Aurora';
                $mail->Body    = "<!DOCTYPE html>
                                    <html lang='es'>
                                        ...
                                        <head>
                                            ...
                                            <title>Restablecer contraseña | Cocinas Aurora</title>
                                            <style type='text/css'>
                                                body {
                                                    width: 100% !important;
                                                    height: 100%;
                                                ...
                                                .ancla-recuperar:hover {
                                                    background-color: #ce6d0d !important;
                                                    border-color: #ce6d0d !important;
                                                }
                                            </style>
                                                        ...
                                                        <table class='email-content' width='100%' cellpadding='0' cellspacing='0' style='box-sizing: border-box; font-family: Arial, Helvetica, sans-serif; margin:
                                                            ...
                                                            <tr>
                                                                <td class='email-masthead'
                                                                    ...
                                                                    align='center'>
                                                                    <a class='ancla-cocinas' href='https://cocinas-aurora.epizy.com/'
                                                                        ...
                                                                        <tr>
                                                                            <td class='content-cell'
                                                                                ...
                                                                                <p style='box-sizing: border-box; color: #74787E; font-family: Arial, Helvetica, sans-serif; font-size: 16px; line-height: 1.5em;
                                                                                    ...
                                                                                    en Cocinas Aurora. Use el botón de abajo para cambiarla.
                                                                                </p>
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                <td style='box-sizing: border-box; font-family: Arial, Helvetica, sans-serif;
                                                                                                                    ...
                                                                                                                    <a class='ancla-recuperar'
                                                                                                                        href='https://cocinas-aurora.epizy.com/nueva_password?token=$toke&&correo=$destino'
                                                                                                                        class='button button--green'
                                                                                                                        target='_blank' style='-webkit-text-size-adjust: none; background: #ef800d; border-color: #e77e0d; border-radius: 3px; border-style: solid; border-width: 10px 18px; box-shadow: 0 2px 3px rgba(0, 0, 0, 0.16); box-sizing: border-box; color: #FFF; display: inline-block; font-family: Arial, Helvetica, sans-serif;
                                                                                ...
                                                                                <p style='box-sizing: border-box; color: #74787E; font-family: Arial, Helvetica, sans-serif; font-size: 16px; line-height: 1.5em;
                                                                                    margin-top: 0;' align='left'> Por razones de seguridad, esta solicitud se
                                                                                    recibió de un
                                                                                    ...
                                                                                    <tr>
                                                                                        <td
                                                                                            ...
                                                                                            <p class='sub' style='box-sizing: border-box; color: #74787E; font-family: Arial, Helvetica, sans-serif; font-size: 12px;
                                                                                                ...
                                                                                                pegue la siguiente URL en su navegador web o de click.</p>
                                                                                            <p class='sub' style='box-sizing: border-box; color: #74787E; font-family: Arial, Helvetica, sans-serif; font-size: 12px;
                                                                                                line-height: 1.5em; margin-top: 0;' align='left'>
                                                                                                https://cocinas-aurora.epizy.com/nueva_password?token=$toke&&correo=$destino
                                                                                            </p>
                                                                                        </td>
                                                                                    </tr>
                                                                                </table>
