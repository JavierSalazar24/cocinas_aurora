<?php
    ...
    if(isset($_SESSION['admin']) || isset($_SESSION['estandar'])){  
        ...
        /* consulta de guarniciones */
        $C_consulta= (new MongoDB\Client('mongodb+srv://admin:adminBDCA@bdca.9e4qi.mongodb.net/cocinas_aurora?retryWrites=true&w=majority'))->cocinas_aurora->guarniciones; 
...
<head>
    ...
    <title>Guarniciones | Panel de control</title>
</head>
...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                <div class="container-fluid">
                    ...
                    <!-- Titulo -->
                    <h1 class="h3 mb-2 text-gray-800">Guarniciones</h1>

                    <!-- Tabla Guarniciones -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-warning">Tabla de guarniciones</h6>
                        </div>
                                ...
                                <form id="formulario">
                                    <table class="table table-bordered" id="alimentos" width="100%" cellspacing="0">                            
                                        ...
                                        <tbody class="text-dark">
                                            <?php
                                                foreach($consulta as $guarniciones){
                                            ?>
                                            <tr role="row">
                                                <td><span id="comida_tdID"><?php echo $guarniciones['_id']; ?></span></td>
                                                <td><span id="comida_tdNombre"><?php echo $guarniciones['nombre']; ?></span></td>
                                                <td><span id="comida_tdDia"><?php echo $guarniciones['dia']; ?></span></td>
                                                <td><span id="comida_tdDesc"><?php echo $guarniciones["descripcion"]; ?></span></td>
                                                <td><span id="comida_tdPrecioCuarto"><?php echo $guarniciones["precio_cuarto"]; ?></td>
                                                <td><span id="comida_tdPrecioMedio"><?php echo $guarniciones["precio_medio"]; ?></td>
                                                <td><span id="comida_tdPrecioLitro"><?php echo $guarniciones["precio_litro"]; ?></td>
                                                <td><img id="alimentoIMG" height="60rem" src="../img_alimentos/<?php echo $guarniciones['imagen']?>"></td>
                                                <?php
                                                    if(isset($_SESSION['admin'])){
                                                ?>
                                                    <td class="text-white">
                                                        <a id="btn_editarAlimento" class="btn btn-success a_panel" data-toggle="modal" data-target="#GuarnicionModalE"><i class="fas fa-pencil-alt" style="color: white !important;"></i></a>
                                                        <a class="btn btn-danger a_panel" onclick="ConfirmarEliminacion('guarniciones', '<?php echo $guarniciones['_id']?>')"><i class="fas fa-trash" style="color: white !important;"></i></a>
                                                        <div class="form-check form-check-inline">
                                                            <input type="checkbox" name="eliminar-mult[]" value="<?php echo $guarniciones['_id']?>">
                                                        </div>
                                                    </td>
                                                <?php
                                                    }
                                    ...
                                    ?>
                                        <div class="row mt-5">
                                            <div class="col-12 col-md-6 mb-2 text-center">
                                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#GuarnicionModal" id="alimento_agregar"><i class="fas fa-plus"></i> Agregar nueva guarnición</button>
                                            </div>
                                            <div class="col-12 col-md-6 mb-5 text-center">
                                                <button class="btn btn-danger" type="submit" onclick="EliminacionMult('guarniciones')"><i class="fas fa-minus-circle"></i> Eliminar registros seleccionados</button>
    ...
    <!-- Modal Agregar guarnicion-->
    <form id="agregar" class="needs-validation" novalidate>
        <div class="modal fade" id="GuarnicionModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header bg-primary text-white">
                        <h5 class="modal-title" id="exampleModalLabel">Agregar guarnición</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label for="precioCuarto_agregar" class="form-label">Precio 1/4</label>
                        ...
                        <div class="mb-3">
                            <label for="precioMedio_agregar" class="form-label">Precio 1/2</label>
                        ...
                        <div class="mb-3">
                            <label for="precioLitro_agregar" class="form-label">Precio Litro</label>
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-primary" onclick="agregarAlimento('guarniciones')">Agregar guarnición</button>
    ...
    <!-- Modal Editar guarnicion-->
    <form id="editar" class="needs-validation" novalidate>
        <div class="modal fade" id="GuarnicionModalE" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header bg-success text-white">
                        <h5 class="modal-title" id="exampleModalLabel">Editar guarnición</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    </div>
                    <div class="modal-body">
                        <div class="mb-3">
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-success" onclick="editarAlimento('guarniciones')">Editar guarnición</button>
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                    </div>
                </div>
            </div>
