<?php
    ...
    if(isset($_SESSION['admin']) || isset($_SESSION['estandar'])){  
        ...
        /* consulta de sopas */
        $C_consulta= (new MongoDB\Client('mongodb+srv://admin:adminBDCA@bdca.9e4qi.mongodb.net/cocinas_aurora?retryWrites=true&w=majority'))->cocinas_aurora->sopas; 
...
<head>
    ...
    <title>Sopas | Panel de control</title>
</head>
...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                <div class="container-fluid">
                    ...
                    <!-- Titulo -->
                    <h1 class="h3 mb-2 text-gray-800">Sopas</h1>

                    <!-- Tabla Sopas -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-warning">Tabla de sopas</h6>
                        </div>
                                ...
                                <form id="formulario">
                                    <table class="table table-bordered" id="alimentos" width="100%" cellspacing="0">                            
                                        ...
                                        <tbody class="text-dark">
                                            <?php
                                                foreach($consulta as $sopas){
                                            ?>
                                            <tr role="row">
                                                <td><span id="comida_tdID"><?php echo $sopas['_id']; ?></span></td>
                                                <td><span id="comida_tdNombre"><?php echo $sopas['nombre']; ?></span></td>
                                                <td><span id="comida_tdDia"><?php echo $sopas['dia']; ?></span></td>
                                                <td><span id="comida_tdDesc"><?php echo $sopas["descripcion"]; ?></span></td>
                                                <td><span id="comida_tdPrecioCuarto"><?php echo $sopas["precio_cuarto"]; ?></td>
                                                <td><span id="comida_tdPrecioMedio"><?php echo $sopas["precio_medio"]; ?></td>
                                                <td><span id="comida_tdPrecioLitro"><?php echo $sopas["precio_litro"]; ?></td>
                                                <td><img id="alimentoIMG" height="60rem" src="../img_alimentos/<?php echo $sopas['imagen']?>"></td>
                                                <?php
                                                    if(isset($_SESSION['admin'])){
                                                ?>
                                                    <td class="text-white">
                                                        <a id="btn_editarAlimento" class="btn btn-success a_panel" data-toggle="modal" data-target="#SopaModalE"><i class="fas fa-pencil-alt" style="color: white !important;"></i></a>
                                                        <a class="btn btn-danger a_panel" onclick="ConfirmarEliminacion('sopas', '<?php echo $sopas['_id']?>')"><i class="fas fa-trash" style="color: white !important;"></i></a>
                                                        <div class="form-check form-check-inline">
                                                            <input type="checkbox" name="eliminar-mult[]" value="<?php echo $sopas['_id']?>">
                                                        </div>
                                                    </td>
                                                <?php
                                                    }
                                    ...
                                    ?>
                                        <div class="row mt-5">
                                            <div class="col-12 col-md-6 mb-2 text-center">
                                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#SopaModal" id="alimento_agregar"><i class="fas fa-plus"></i> Agregar nueva sopa</button>
                                            </div>
                                            <div class="col-12 col-md-6 mb-5 text-center">
                                                <button class="btn btn-danger" type="submit" onclick="EliminacionMult('sopas')"><i class="fas fa-minus-circle"></i> Eliminar registros seleccionados</button>
                                            </div>
                                        </div>
                                    <?php
                                        }
    ...
    <form id="agregar" class="needs-validation" novalidate>
        <div class="modal fade" id="SopaModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header bg-primary text-white">
                        <h5 class="modal-title" id="exampleModalLabel">Agregar sopa</h5>
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-primary" onclick="agregarAlimento('sopas')">Agregar sopa</button>
    ...
    <form id="editar" class="needs-validation" novalidate>
        <div class="modal fade" id="SopaModalE" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header bg-success text-white">
                        <h5 class="modal-title" id="exampleModalLabel">Editar sopa</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    </div>
                    <div class="modal-body">
                        <div class="mb-3">
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-success" onclick="editarAlimento('sopas')">Editar sopa</button>
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                    </div>
                </div>
            </div>
