<?php
    ...
    $consulta_horarios = (new MongoDB\Client('mongodb+srv://admin:adminBDCA@bdca.9e4qi.mongodb.net/cocinas_aurora?retryWrites=true&w=majority'))->cocinas_aurora->guisos;
...
<head>
    ...
    <title> ❤️ Guisos del día <?php echo $dia ?> | Cocina Aurora ❤️ </title>
    <meta name="description" content="La comida del dia sobre los guisos🍲 que encontrarás cada día de la semana te sorprenderán🤩, porque cocina economica Cocinas Aurora tiene para ti los mejores guisos cada dia de la semana😍, visitanos de Lunes a Viernes y encontraras diferentes guisos delicios del dia.😋">
</head>
                ...
                <div data-on="false" data-md-on="true" class="rd-parallax">
                    <div data-speed="0.05" data-type="html" class="rd-parallax-layer">
                        <div class="shell section-70 section-md-114">
                            <h1 class="text-bold view-animate fadeInUpSmall delay-04 h2">Guisos del día <?php echo $dia ?></h1>
                                ...
                                ?>
                                    <div class="tarjeta_comida cell-xs-8 cell-sm-6 cell-md-4 cell-lg-3 view-animate fadeInRightSm delay-08 offset-top-40 offset-md-top-40">
                                        <article class="tarjeta_comida_article post-news post-news-mod-1 view-animate fadeInRightSm delay-1">
                                            <img src="<?php echo 'https://cocinas-aurora.herokuapp.com/img_alimentos/'.$comida['imagen']?>" alt="<?php echo $comida['descripcion'] ?>" class="img-responsive img_comidas">
