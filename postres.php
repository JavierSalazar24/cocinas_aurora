<?php
    ...
    $consulta_horarios = (new MongoDB\Client('mongodb+srv://admin:adminBDCA@bdca.9e4qi.mongodb.net/cocinas_aurora?retryWrites=true&w=majority'))->cocinas_aurora->postres;
...
<head>
    ...
    <title> ❤️ Postres del día <?php echo $dia ?> | Cocina Aurora ❤️ </title>
    <meta name="description" content="La comida del dia sobre los postres🍮 que encontrarás cada día de la semana te sorprenderán🤩, porque cocina economica Cocinas Aurora tiene para ti los mejores postres cada dia de la semana😍, visitanos de Lunes a Viernes y encontraras diferentes postres delicios del dia.😋">
</head>
                ...
                <div data-on="false" data-md-on="true" class="rd-parallax">
                    <div data-speed="0.05" data-type="html" class="rd-parallax-layer">
                        <div class="shell section-70 section-md-114">
                            <h1 class="text-bold view-animate fadeInUpSmall delay-04 h2">Postres del día <?php echo $dia ?></h1>
                                        ...
                                        <article class="tarjeta_comida_article post-news post-news-mod-1 view-animate fadeInRightSm delay-1">
                                            ...
                                            <div class="post-news-meta offset-top-20">
                                                <ul style="list-style-position: inside; margin: 0; padding: 0;">
                                                    ...
                                                    <?php }else { ?>
                                                        <li class="text-left text-italic text-rojo text-center">No se ha añadido todavía un precio</li>
                                                    <?php } ?>
                                                </ul>
                                            </div>
                                        </article>
