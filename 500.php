...
<head>
  ...
  <title> ❤️ Error | Cocinas Aurora ❤️ </title>
</head>
      ...
      <div class="section-404-cover">
        <div class="section-cover section-404 section-30">
          <div class="section-50">
            <div class="shell">
              <div>
                <h1 class="font-default"><span class="big text-light text-bold">500</span></h1>
              </div>
              ...
              <div class="offset-top-30 offset-lg-top-60">
                <p>Algo ha ido mal en el servidor del sitio web, pero el servidor no puede ser más específico sobre cuál es el problema exacto.</p>
              </div>
              <div class="offset-top-15 offset-lg-top-30">
                <div class="group group-xl">
                  <a href="https://cocinas-aurora.herokuapp.com/https://cocinas-aurora.herokuapp.com/" class="btn btn-primary btn-icon btn-icon btn-icon-left offset-top-10">
                    <span class="icon fa-arrow-left"></span>
                    <span>Volver a la página de inicio</span>
                  </a>
                  <a href="https://cocinas-aurora.herokuapp.com/https://cocinas-aurora.herokuapp.com/#contactanos" class="btn btn-default btn-icon btn-icon btn-icon-left offset-top-10">
          ...
          <div>
            <p>&copy;<span id="copyright-year"></span> Hecho por Cocinas Aurora. Todos los derechos reservados. <a rel="nofollow" href="https://cocinas-aurora.herokuapp.com/privacidad" style="color: #000; text-decoration: underline">Política de privacidad.</a></p>
          </div>
        </div>
      </div>
    </main>
