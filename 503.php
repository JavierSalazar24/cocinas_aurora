      ...
      <div class="section-404-cover">
        <div class="section-cover section-404 section-30">
          <div class="section-50">
            <div class="shell">
              <div>
                <h1 class="font-default"><span class="big text-light text-bold">503</span></h1>
              </div>
              <div class="offset-top-10">
                <h2 class="text-bold">Lo siento, servicio no disponible</h2>
              </div>
              <div class="offset-top-15 offset-lg-top-30">
                <hr class="divider bg-madison">
              </div>
              <div class="offset-top-30 offset-lg-top-60">
                <p>Algo ha ido mal en el servidor del sitio web, puede que este saturado o en mantenimiento.</p>
              </div>
              <div class="offset-top-15 offset-lg-top-30">
